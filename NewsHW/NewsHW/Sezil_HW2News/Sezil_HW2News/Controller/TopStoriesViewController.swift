...
final class TopStoriesViewController: UIViewController, ArticleFetchDelegate, LoadingShowable {
...
extension TopStoriesViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let DetailViewController = self.storyboard?.instantiateViewController(withIdentifier: "StoryDetailsViewController") as! DetailsViewController
        DetailViewController.article = articleViewModel?.articles[indexPath.row]
